...
export function EntregaItem({ pedido }: EntregaItemProps) {
  ...
  return (
    <article className="bg-white rounded-xl shadow-sm border border-gray-200 py-4 px-5 space-y-3">
      ...
      {/* Acción */}
      {esEntregado ? (
        <div className="flex items-center gap-2 py-2 text-green-700 font-outfit font-semibold text-base">
          <svg
